	...
	<div class="col-xs-12 col-sm-12 col-md-12">
        ...
        <div class="form-group">
            ...
            <div class="form-group{{ $errors->has('slug') ? ' has-error' : '' }}">
                ...
                <input type="text" class="form-control" id="post_excerpt" name="post_excerpt" placeholder="Excerpt">
            ...
            <div class="form-group{{ $errors->has('post_seo_title') ? ' has-error' : '' }}">
                ...
                <input type="text" class="form-control" id="post_seo_title" name="post_seo_title" placeholder="">
